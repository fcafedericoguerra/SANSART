...
class Theplus_Loop_Tooltips_Option_Style_Group extends Elementor\Group_Control_Base {

	protected static $fields;
	
	public static function get_type() {
		return 'plus-loop-tooltips-option-style';
	}
	...
	protected function init_fields() {
		...
		$fields['toolip_padding'] = array(
			...
			'size_units' => [ 'px', '%', 'em' ],
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
			'separator' => 'after',
		);
		...
		$fields['toolip_color'] = array(
			...
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'background-color: {{VALUE}};',
			),
			'condition' => array(
		...
		$fields['toolip_gradient_angle'] = array(
			...
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{toolip_color.VALUE}} {{toolip_color_stop.SIZE}}{{toolip_color_stop.UNIT}}, {{toolip_color_b.VALUE}} {{toolip_color_b_stop.SIZE}}{{toolip_color_b_stop.UNIT}})',
			),
			'condition' => array(
				'toolip_background'    => array( 'gradient' ),
		...
		$fields['toolip_gradient_position'] = array(
			...
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'background-color: transparent; background-image: radial-gradient(at {{VALUE}}, {{toolip_color.VALUE}} {{toolip_color_stop.SIZE}}{{toolip_color_stop.UNIT}}, {{toolip_color_b.VALUE}} {{toolip_color_b_stop.SIZE}}{{toolip_color_b_stop.UNIT}})',
			),
			'condition' => array(
				'toolip_background'    => array( 'gradient' ),
		...
		$fields['plus_tooltip_border'] = array(
			...
			'separator' => 'before',
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'border-style: {{VALUE}};',
			),
		);
		...
		$fields['plus_tooltip_border_width'] = array(
			...
			'type'      => Controls_Manager::DIMENSIONS,
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
			'condition' => array(
				'plus_tooltip_border!' => '',
			),
		...
		$fields['plus_tooltip_border_color'] = array(
			...
			'default' => '',
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'border-color: {{VALUE}};',
			),
			'condition' => array(
				'plus_tooltip_border!' => '',
			),
		...
		$fields['plus_tooltip_border_radius'] = array(
			...
			'size_units' => array( 'px', '%' ),
			'selectors'  => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
			'separator' => 'after',
		);
		...
		$fields['plus_tooltip_box_shadow'] = array(
			...
			'selectors' => array(
				'{{WRAPPER}} {{CURRENT_ITEM}} .tippy-tooltip' => 'box-shadow:  {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}} {{box_shadow_position.VALUE}};',
			),
		);
		return $fields;
	}
