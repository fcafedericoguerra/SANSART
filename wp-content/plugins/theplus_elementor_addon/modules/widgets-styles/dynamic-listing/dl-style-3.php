	...
	<div class="blog-list-content d-flex flex-row flex-wrap tp-align-items-center">
		...
		<div class="post-content-image <?php echo esc_attr( $column_class_1 ); ?> flex-column flex-wrap">
			<a href="<?php echo esc_url( get_the_permalink() ); ?>">
				<?php include THEPLUS_WSTYLES . 'dynamic-listing/format-image.php'; ?>
			</a>
		</div>
		<?php } ?>
		<div class="post-content-bottom <?php echo esc_attr( $column_class_2 ); ?> flex-column flex-wrap">
			...
			if ( ! empty( $style_layout ) ) {
				include THEPLUS_WSTYLES . 'dynamic-listing/dl-style-3-' . $style_layout . '.php';
			} else {
				include THEPLUS_WSTYLES . 'dynamic-listing/dl-style-3-layout-style-1.php';
			}
			/*tp quick view start*/
