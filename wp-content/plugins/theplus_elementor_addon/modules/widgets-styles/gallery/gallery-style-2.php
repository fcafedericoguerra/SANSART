...
if ( 'metro' !== $layout ) {
	...
	<div class="post-content-image">
		...
		if ( ! empty( $custom_url ) ) {
			...
			<?php } else { ?>
				<a href="<?php echo esc_url( $full_image ); ?>" <?php echo $popup_attr_icon1; ?>><?php include THEPLUS_WSTYLES . 'gallery/format-image.php'; ?></a>
				<?php
			}
		} else {
	...
	<div class="post-content-center">
		...
		<div class="post-zoom-icon">
			...
			if ( ! empty( $display_icon_zoom ) && 'yes' === $display_icon_zoom ) {
				include THEPLUS_WSTYLES . 'gallery/meta-icon.php';
			}
			?>
		</div>
