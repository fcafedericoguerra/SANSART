	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .pt_plus_breadcrumbs_bar .pt_plus_breadcrumbs_bar_inner.bred_style_2 nav#breadcrumbs a,{{WRAPPER}} .pt_plus_breadcrumbs_bar .pt_plus_breadcrumbs_bar_inner.bred_style_2 nav#breadcrumbs span.current .current_tab_sec,{{WRAPPER}} .pt_plus_breadcrumbs_bar .pt_plus_breadcrumbs_bar_inner.bred_style_2 nav#breadcrumbs .current_active .current_tab_sec,{{WRAPPER}} .pt_plus_breadcrumbs_bar #breadcrumbs',
			)
		);
		...
		$this->add_control(
			'letter_limit_parent',
			array(
				'label'     => esc_html__( 'Letter', 'theplus' ),
