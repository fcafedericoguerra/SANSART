		...
		*/
		...
		public function add_widgets( $widgets_manager ) {
			...
			$grouped = array(
				...
				'tp_plus_form' => '\TheplusAddons\Widgets\ThePlus_Plus_Form',
		 ...
		 * @since 6.1.0
		 */
		public function theplus_white_label_option($field){
		...
		public function tp_white_label_update( $all_plugins ){
			$plugin_name = $this->theplus_white_label_option('tp_plugin_name');
			$tp_plugin_desc = $this->theplus_white_label_option('tp_plugin_desc');
			$tp_author_name = $this->theplus_white_label_option('tp_author_name');
			$tp_author_uri = $this->theplus_white_label_option('tp_author_uri');
		...
		public function include_widget( $widget_id, $grouped = false ) {
			...
			$free_widget = array( 'tp_adv_text_block', 'tp_age_gate', 'tp_blockquote', 'tp_dark_mode', 'tp_messagebox', 'tp_progress_bar', 'tp_post_title', 'tp_post_content', 'tp_post_featured_image', 'tp_post_navigation', 'tp_post_author', 'tp_post_comment', 'tp_post_meta', 'tp_syntax_highlighter', 'tp_navigation_menu_lite', 'tp_heading_animation', 'tp_hovercard', 'tp_video_player', 'tp_smooth_scroll', 'tp_social_embed', 'tp_contact_form_7', 'tp_everest_form', 'tp_gravity_form', 'tp_meeting_scheduler', 'tp_ninja_form', 'tp_wp_forms' );
		
			$filename = sprintf('modules/widgets/'.$widget_id.'.php');
		
			if(  in_array( $widget_id, $free_widget, true ) ){
