(function ($) {
    ...
    var WidgetAdvancedButtons = function ($scope, $) {
        var container_js = $scope[0].querySelectorAll('.pt-plus-adv-button-wrapper');
        ...
        function adjustPolyline(button) {
            var polyline2 = button.querySelector('.tp-cpt-btn02');
            ...
            var dashArray = `20 ${perimeter}`;
            var dashOffset = -perimeter;
            
            if( polyline2 && polyline2.style ){
                polyline2.style.strokeDasharray = dashArray;
                polyline2.style.strokeDashoffset = 20;
                ...
                button.addEventListener('mouseleave', () => {
                    polyline2.style.strokeDashoffset = dashOffset;
                });
            }
        ...
        // Style 10
        var buttons = container_js[0].querySelectorAll('.adv-button-link-wrap');
            buttons.forEach(button => {
                adjustPolyline(button);
                window.addEventListener('resize', () => adjustPolyline(button));
            });
