...
(function( $ ) {
	"use strict";
	var WidgetTeamListingHandler = function ($scope, $) {

		var wish_filter = $scope.find('.team-member-list');
	...
	$(window).on('elementor/frontend/init', function () {
		elementorFrontend.hooks.addAction('frontend/element_ready/tp-team-member-listout.default', WidgetTeamListingHandler);
	});
