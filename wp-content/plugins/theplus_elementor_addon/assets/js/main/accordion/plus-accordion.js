                    ...
                    if (highlight) {
                        ...
                        findstring.forEach(function (self) {
                            ...
                            function removeHighlights(element) {
                                let highlightedElements = element.querySelectorAll('mark.tp-highlight');
                            ...
                            function highlightText(element) {
                                element.childNodes.forEach(function (node) {
                                    if (node.nodeType === Node.TEXT_NODE) {
                                        let newNodeValue = node.nodeValue.replace(searchRegex, '<mark class="tp-highlight">$&</mark>');
                                        let tempContainer = document.createElement('div');
                                        tempContainer.innerHTML = newNodeValue;
                            ...
                            if (content_editor) {
                                let videoContainer = content_editor.querySelector('.ts-video-wrapper');
                    
                                if (videoContainer) {
                                  
                                    let videoElements = Array.from(videoContainer.querySelectorAll('video, source, track'));
                    
                                    videoElements.forEach(function (videoElement) {
                                        videoElement.parentNode.removeChild(videoElement);
                                    });
                    
                                    removeHighlights(content_editor);
                                    highlightText(content_editor);
