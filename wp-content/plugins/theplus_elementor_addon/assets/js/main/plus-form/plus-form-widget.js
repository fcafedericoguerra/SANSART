(function ($) {
    ...
    var WidgetFormHandler = function ($scope, $) {
        ...
        var requiredAsterisks = container.querySelectorAll('.tpaep-required-asterisk');
        ...
        form.addEventListener('submit', function (e) {
           ...
           var formFields = [];
            ...
            form.querySelectorAll('.tpaep-form-field').forEach(function (field) {
        ...
        var clearMessages = function () {
            form.querySelectorAll('.tpaep-form-messages').forEach(function (message) {
                message.remove();
            });
            form.querySelectorAll('.tpaep-field-error').forEach(function (error) {
                error.remove();
            });
        };
