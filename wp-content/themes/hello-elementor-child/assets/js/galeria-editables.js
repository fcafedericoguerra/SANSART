jQuery(document).ready(function($) {
  ...
  // === FILTROS DINÁMICOS ===
  $('#filtro-tamano, #filtro-material, #ordenar').on('change', function() {
    const tamano    = $('#filtro-tamano').val();
    const material  = $('#filtro-material').val();
